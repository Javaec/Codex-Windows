...
function writeLiteContract(outputDir, payload) {
    ...
    const contract = {
        ...
        bundledTools: {
            ...
            commandRunner: fs.existsSync(path.join(outputDir, "resources", "codex-command-runner.exe")),
            sandboxSetup: fs.existsSync(path.join(outputDir, "resources", "codex-windows-sandbox-setup.exe")),
            ripgrep: fs.existsSync(path.join(outputDir, "resources", "rg.exe")),
            notificationSound: fs.existsSync(path.join(outputDir, "resources", "notification.wav")),
...
function writeBuildMetadata(outputDir, metadata) {
    ...
    const payload = {
        ...
        bundledCommandRunnerPath: path.join(outputDir, "resources", "codex-command-runner.exe"),
        bundledWindowsSandboxSetupPath: path.join(outputDir, "resources", "codex-windows-sandbox-setup.exe"),
        ...
        bundledNotificationSoundPath: path.join(outputDir, "resources", "notification.wav"),
