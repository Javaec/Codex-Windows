...
exports.buildArchitectureMarkdown = buildArchitectureMarkdown;
...
function buildArchitectureMarkdown(input) {
...
${(0, domain_boundaries_1.formatDomainReportMarkdown)(input.domainReport, input.top, input.domainDefinitions)}
