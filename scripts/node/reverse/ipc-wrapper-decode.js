...
exports.createIpcWrapperDecodeRuntime = createIpcWrapperDecodeRuntime;
...
function createIpcWrapperDecodeRuntime(input) {
    const { getExpressionName, getPropertyNameText, unwrapExpressionWrappers, isRequireElectronCall, isRequireCall, resolveIpcChannelBindingFromExpression, buildIpcChannelHelperMap, buildIpcChannelConstantEvalMap, normalizeSourceForPrint, resolveLocalImport, isCandidateBoundaryFile, isLikelyCoreAppFile, } = input;
