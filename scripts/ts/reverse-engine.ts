...
export async function runReverseStrictPath(options: ReverseOptions): Promise<number> {
...
export async function runReverseCli(argv: string[] = process.argv.slice(2)): Promise<number> {
